          ...
          <Paper sx={{ p: 2 }}>
            <Grid container>
              <Grid item sm={12} md={6} lg={8} sx={{ display: { sm: "none", md: "flex" } }}>
                <Stack sx={{ position: "relative",width: "100%", display: { xs: "none", sm: "flex" } }} justifyContent="flex-end">
                  <video
                  ...
                  <Stack
                    ...
                    sx={{ backgroundColor: "rgba(0, 0, 255, 0.4)", minHeight: "calc(100vh - 144px)", zIndex: 1 }}
                  >
                    <Stack p={2} spacing={2} sx={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                      <Typography color="white" variant="h4">
                        Browse. Discover. Anslyse.<br />Welcome to {COMPANY}!
                      </Typography>
                      <List disablePadding>
                        <ListItem disableGutters disablePadding>
                          ...
                          <ListItemText
                            sx={{ color: "white" }}
                            primary="Real-Time Questioning: Users can ask questions in real-time and analyse."
                          />
                        </ListItem>
                        <ListItem disableGutters disablePadding>
                          <ListItemIcon>
                          ...
                          <ListItemText
                            sx={{ color: "white" }}
                            primary="Synchronization: The app syncs with the data, allowing users to fetch specific analysis."
                          />
                        </ListItem>
                      </List>
                    </Stack>
